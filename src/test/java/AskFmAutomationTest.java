...
//    }
    ...
    @Test(description="Add user to blocklist")
    public void oneCanAddUserToBlocklist() throws InterruptedException {
        steps.loginAskFm(USERNAME1, PASSWORD1);
        List<String> block = steps.addToBlocklist();
        Assert.assertEquals(block.get(0),block.get(1));
    }
