...
public class Steps {
    ...
    public List<String> addToBlocklist() throws InterruptedException {
        BlockUserPAge blockUserPAge = new BlockUserPAge(driver);
        List<String> blockUser = blockUserPAge.blockUser();
        return blockUser;
    }
